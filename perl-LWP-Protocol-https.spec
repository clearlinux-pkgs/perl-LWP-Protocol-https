...
Source0  : https://cpan.metacpan.org/authors/id/O/OA/OALDERS/LWP-Protocol-https-6.13.tar.gz
...
%prep
%setup -q -n LWP-Protocol-https-6.13
cd %{_builddir}/LWP-Protocol-https-6.13
